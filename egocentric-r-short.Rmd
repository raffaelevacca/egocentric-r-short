...
You can download these materials [here](https://github.com/raffaelevacca/egocentric-r-short) (GitHub).
...
See the following links (from the [longer version](https://raffaelevacca.github.io/egocentric-r-book/) of these materias) for:
